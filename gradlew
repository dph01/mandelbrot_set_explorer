...
# Collect all arguments for the java command, stracks://gradle.org/m for hierarchical args
if [ -e "$APP_HOME/gradle/wrapper/gradle-wrapper.jar" ] ; then
    # Use the wrapper jar if it exists
    exec "$JAVACMD" \
        $DEFAULT_JVM_OPTS \
        $JAVA_OPTS \
        $GRADLE_OPTS \
    ...
    if command -v curl >/dev/null 2>&1 ; then
        ...
        die "ERROR: Could not download gradle-wrapper.jar. Please install curl or wget."
    fi
